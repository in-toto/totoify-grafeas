...
class GrafeasApi(object):
    ...
    def create_operation(self, project_id, operation_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_operation(project_id, operation_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str projects_id: Part of `parent`. This field contains the projectId for example: \"projects/{project_id}\" (required)
        :param Occurrence operation: The operation to be inserted
        :return: Occurrence
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_operation_with_http_info(project_id, operation_id, **kwargs)
        else:
            (data) = self.create_operation_with_http_info(project_id, operation_id, **kwargs)
            return data

    def create_operation_with_http_info(self, project_id, operation_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_operation_with_http_info(operation_id, callback=callback_function)
        ...
        all_params = ['projects_id', 'operation']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
